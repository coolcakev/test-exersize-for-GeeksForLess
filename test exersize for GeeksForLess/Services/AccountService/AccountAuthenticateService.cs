...
namespace test_exersize_for_GeeksForLess.Services.Account
{
    ...
    public class AccountAuthenticateService : IAccountAuthenticateService
    {
        ...
        public async Task<bool> RegisterPerson(RegisterAccountModel model)
        {
            ...
            //Regex loginFormat = new Regex(@"([^0-9]){4,}");
            ...
            //var isValidPasswordFormat = passwordFormat.IsMatch(user.Password);
